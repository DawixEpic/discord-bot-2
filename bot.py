...
TICKET_CHANNEL_ID = 1373305137228939416  # ID kanału z ticketami
EMBED_COLOR = discord.Color.from_rgb(35, 39, 42)  # kolor zbliżony do Discordowego dark
...
async def on_ready():
    ...
    for channel_id, message_text in CHANNEL_MESSAGES.items():
        ...
        try:
            ...
            print(f"Błąd podczas usuwania wiadomości w {channel_id}: {e}")
        ...
        embed.set_footer(text="Kliknij przycisk poniżej, aby otworzyć ticket i dokonać zakupu.")
        ...
        try:
            ...
            print(f"Błąd przy wysyłaniu wiadomości do kanału {channel_id}: {e}")
...
if __name__ == "__main__":
    ...
    if not TOKEN:
        print("Ustaw zmienną środowiskową DISCORD_TOKEN z tokenem bota.")
    else:
        bot.run(TOKEN)
